...
enum NativeLocalization {
    ...
    private static let translations: [String: [String: String]] = [
        "zh-Hant": [
            ...
            "textToTextModelPanelTitle": "選取文生文模型資料夾",
            "textToTextModelDownloadDirectoryPanelTitle": "選取文生文模型儲存目錄",
            "agentModelDownloadDirectoryPanelTitle": "選取 Agent 模型儲存目錄",
            "imageToTextModelPanelTitle": "選取多模態模型資料夾",
            "imageToTextModelDownloadDirectoryPanelTitle": "選取多模態模型儲存目錄",
            "imageColorizationModelPanelTitle": "選取上色模型資料夾",
            "imageColorizationModelDownloadDirectoryPanelTitle": "選取上色模型儲存目錄",
        ...
        "en": [
            ...
            "textToTextModelPanelTitle": "Choose a text-to-text model folder",
            "textToTextModelDownloadDirectoryPanelTitle": "Choose a text-to-text model storage folder",
            "agentModelDownloadDirectoryPanelTitle": "Choose an Agent model storage folder",
            "imageToTextModelPanelTitle": "Choose a multimodal model folder",
            "imageToTextModelDownloadDirectoryPanelTitle": "Choose a multimodal model storage folder",
            "imageColorizationModelPanelTitle": "Choose an image colorization model folder",
            "imageColorizationModelDownloadDirectoryPanelTitle": "Choose an image colorization model storage folder",
        ...
        "ja": [
            ...
            "textToTextModelPanelTitle": "テキスト生成モデルのフォルダを選択",
            "textToTextModelDownloadDirectoryPanelTitle": "テキスト生成モデルの保存先を選択",
            "agentModelDownloadDirectoryPanelTitle": "Agent モデルの保存先を選択",
            "imageToTextModelPanelTitle": "マルチモーダルモデルのフォルダを選択",
            "imageToTextModelDownloadDirectoryPanelTitle": "マルチモーダルモデルの保存先を選択",
            "imageColorizationModelPanelTitle": "着色モデルのフォルダを選択",
            "imageColorizationModelDownloadDirectoryPanelTitle": "着色モデルの保存先を選択",
        ...
        "ko": [
            ...
            "textToTextModelPanelTitle": "텍스트→텍스트 모델 폴더 선택",
            "textToTextModelDownloadDirectoryPanelTitle": "텍스트→텍스트 모델 저장 폴더 선택",
            "agentModelDownloadDirectoryPanelTitle": "Agent 모델 저장 폴더 선택",
            "imageToTextModelPanelTitle": "멀티모달 모델 폴더 선택",
            "imageToTextModelDownloadDirectoryPanelTitle": "멀티모달 모델 저장 폴더 선택",
            "imageColorizationModelPanelTitle": "채색 모델 폴더 선택",
            "imageColorizationModelDownloadDirectoryPanelTitle": "채색 모델 저장 폴더 선택",
